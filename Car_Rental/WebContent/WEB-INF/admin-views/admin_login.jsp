...
<body>
   ...
   <form class=" fo w-50 p-3 row   mx-auto  text-light  needs-validation " method="post" style="margin-top:150px; ">
    ...
    <label for="inputEmail4"  class="form-label">Username</label>
      <input type="text"  name="admin_username"  class="form-control" id="inputAddress" placeholder="Username" required="required">
  </div>
  <div class="col-md-12 mt-2">
    <label for="inputPassword4"  class="form-label">Password</label>
    <input type="password"  name="admin_password" class="form-control"  placeholder="Password"  id="inputPassword4" required="required">
  </div>
