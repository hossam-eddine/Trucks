...
<body >
   <form class=" fo w-50 p-3 row   mx-auto  text-light  needs-validation " method="post" style="margin-top:150px; ">
    ...
    <label for="CIN" class="form-label">CIN</label>
     ...
     <input type="text"   name="cin"  class="form-control" id="inputEmail4" required="required">
  </div>
   <div class="col-md-6 mt-2">
  ...
  <div class="col-md-6 mt-2">
    ...
    <input type="password"  name="password" class="form-control" id="inputPassword4" required="required">
  </div>
  ...
  <div class="col-12 mt-5" >
       ...
       <input type="submit" class=" rounded-pill btn btn-outline-primary form-control" value="Sign Up" >
  </div>
  
  <div class="col-3 mx-auto   mt-2 btn btn-outline-danger   ">
  <a href="connect" class="link-primary  ">Sign in </a>
  </div>
</form>
